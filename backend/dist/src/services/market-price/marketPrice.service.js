...
import { MARKET_PRICE_SYSTEM_PROMPT, MARKET_PRICE_MODEL_ID, MARKET_PRICE_MAX_TOKENS, } from "../../constants/marketPrice.constants";
import { LANGUAGE_NAMES } from "../../constants/voice.constants";
export class MarketPriceService {
    constructor(bedrock) {
        this.bedrock = bedrock;
    }
    async getInsight(req, language = "en-AU") {
    ...
    buildUserMessage(req) {
        return (`Commodity: ${req.commodityName}\n` +
    ...
    buildDefaultResponse(req) {
        const aboveAvg = req.currentPrice > req.averagePrice;
        const recommendation = aboveAvg
            ? "sell_now"
            : "wait_to_buy";
        return {
            recommendation,
...
//# sourceMappingURL=marketPrice.service.js.map