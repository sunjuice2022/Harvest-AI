 ...
 */
function makePriceHistory(base, volatility, trend) {
    const history = [];
...
const COMMODITIES = RAW.map(buildCommodity);
export function mockGetMarketPrices() {
    return {
        commodities: COMMODITIES,
        lastUpdated: new Date().toISOString(),
    };
}
export function mockGetMarketInsight(req) {
...
//# sourceMappingURL=marketPrice.mock.js.map