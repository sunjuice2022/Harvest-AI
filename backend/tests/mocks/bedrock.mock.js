export async function mockDiagnoseCrop(message, imageBase64) {
    // Simulate API delay
    ...
    if (normalizedMessage.includes("tomato") && (normalizedMessage.includes("yellow") || normalizedMessage.includes("spot"))) {
        return {
            ...
            confidence: 92,
            severity: "warning",
            description: "Early Blight (Alternaria solani) is a fungal disease that primarily affects tomato leaves. It starts as small brown spots with concentric rings, gradually enlarging and causing leaf yellowing and defoliation.",
            treatment: [
    ...
    if (normalizedMessage.includes("white powder") || normalizedMessage.includes("powdery")) {
        return {
            ...
            confidence: 88,
            severity: "warning",
            description: "Powdery mildew is a fungal infection characterized by white powdery coating on leaves. It affects photosynthesis and can cause leaf curling.",
            treatment: [
    ...
    if (normalizedMessage.includes("yellow leaf") || normalizedMessage.includes("pale")) {
        return {
            ...
            confidence: 85,
            severity: "info",
            description: "Nitrogen deficiency causes yellowing of lower leaves first, progressing upward. Leaves may drop prematurely.",
            treatment: [
...
//# sourceMappingURL=bedrock.mock.js.map