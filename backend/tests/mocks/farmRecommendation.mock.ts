...
const MOCK_LIVESTOCK: LivestockRecommendation[] = [
  {
...
function filterByFarmType(
  farmType: FarmRecommendationRequest["farmType"],
): Pick<FarmRecommendationResponse, "cropRecommendations" | "livestockRecommendations"> {
  return {
...
export function mockFarmRecommendation(
